(() => {
     ...
     */
    function animateWidth(element, start, end, duration = 180) {
        ...
        right: {
            ...
            callbacks: {
                open: (sidebar, initial) => {
                    ...
                    animateWidth(sidebar.el, 0, savedWidth);
                },
                close: (sidebar) => {
            ...
            callbacks: {
                open: (sidebar, initial) => {
                    ...
                    sidebar.interval = setInterval(function () {
                        ...
                        // this are new elements and we have to re-initialize the jQuery UI Resizable
